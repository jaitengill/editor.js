...
let qn = (n = 21) => crypto.getRandomValues(new Uint8Array(n)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
...
function Ie(n, e, t = "log", o, i = "color: inherit") {
  ...
  o && r.push(o);
  const a = "Editor.js 2.31.0-rc.5", l = `line-height: 1em;
            color: #006FEA;
...
const T = Ie.bind(window, !1), X = Ie.bind(window, !0);
function le(n) {
...
function fi(n, e) {
  ...
  return M(t) ? t(n) : te(t) ? n[t] : (t !== void 0 && T("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function Bo(n, e, t) {
  const o = e == null ? void 0 : e.import;
  return M(o) ? o(n, t) : te(o) ? {
    [o]: n
...
var O = /* @__PURE__ */ ((n) => (n.Default = "default", n.Separator = "separator", n.Html = "html", n))(O || {}), ee = /* @__PURE__ */ ((n) => (n.APPEND_CALLBACK = "appendCallback", n.RENDERED = "rendered", n.MOVED = "moved", n.UPDATED = "updated", n.REMOVED = "removed", n.ON_PASTE = "onPaste", n))(ee || {});
class R extends Oe {
  /**
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      l || c ? d = !0 : d = !(a.length > 0 && a.every((p) => {
        ...
        return [
          ...
          ...Array.from(f),
          v
        ].some((S) => (u.isElement(S) || (S = S.parentElement), S && S.closest('[data-mutation-free="true"]') !== null));
...
`);
      ...
      function _(k) {
        ...
        return k.attrs.type === void 0 && (k.attrs.type = "text/css"), V(m, k.attrs), A(k, m), m;
      }
      function V(k, m) {
      ...
      function F(k, m) {
        ...
        if (m.singleton) {
          var N = h++;
          w = d || (d = _(m)), x = ie.bind(null, w, N, !1), I = ie.bind(null, w, N, !0);
        } else
          k.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (w = function(B) {
            ...
            return B.attrs.type === void 0 && (B.attrs.type = "text/css"), B.attrs.rel = "stylesheet", V(W, B.attrs), A(B, W), W;
          }(m), x = (function(B, W, ve) {
...
`);
      ...
      t.exports = (s = "cdx-notifies", r = "cdx-notify", a = "cdx-notify__cross", l = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", d = "cdx-notify__input", h = "cdx-notify__button", p = "cdx-notify__btns-wrapper", { alert: g = function(f) {
        var v = document.createElement("DIV"), A = document.createElement("DIV"), S = f.message, _ = f.style;
        return v.classList.add(r), _ && v.classList.add(r + "--" + _), v.innerHTML = S, A.classList.add(a), A.addEventListener("click", v.remove.bind(v)), v.appendChild(A), v;
      }, confirm: function(f) {
        var v = g(f), A = document.createElement("div"), S = document.createElement("button"), _ = document.createElement("button"), V = v.querySelector("." + a), F = f.cancelHandler, H = f.okHandler;
        return A.classList.add(p), S.innerHTML = f.okText || "Confirm", _.innerHTML = f.cancelText || "Cancel", S.classList.add(h), _.classList.add(h), S.classList.add(l), _.classList.add(c), F && typeof F == "function" && (_.addEventListener("click", F), V.addEventListener("click", F)), H && typeof H == "function" && S.addEventListener("click", H), S.addEventListener("click", v.remove.bind(v)), _.addEventListener("click", v.remove.bind(v)), A.appendChild(S), A.appendChild(_), v.appendChild(A), v;
      }, prompt: function(f) {
        var v = g(f), A = document.createElement("div"), S = document.createElement("button"), _ = document.createElement("input"), V = v.querySelector("." + a), F = f.cancelHandler, H = f.okHandler;
        return A.classList.add(p), S.innerHTML = f.okText || "Ok", S.classList.add(h), S.classList.add(l), _.classList.add(d), f.placeholder && _.setAttribute("placeholder", f.placeholder), f.default && (_.value = f.default), f.inputType && (_.type = f.inputType), F && typeof F == "function" && V.addEventListener("click", F), H && typeof H == "function" && S.addEventListener("click", function() {
          H(_.value);
        }), S.addEventListener("click", v.remove.bind(v)), A.appendChild(_), A.appendChild(S), v.appendChild(A), v;
      }, getWrapper: function() {
    ...
    t.prototype.clean = function(h) {
      ...
      if (f)
        do {
          ...
          var S = !!p.parentNode, _ = i(p) && i(f) && S, V = f.nodeName.toLowerCase(), F = l(this.config, V, f), H = v && A;
          if (H || c(f, F) || !this.config.keepNestedBlockElements && _) {
...
function yt(n, e) {
  return n.map((t) => {
    ...
    return q(o) || (t.data = wt(t.data, o)), t;
  });
}
function Z(n, e = {}) {
  const t = {
...
function Vo(n, e) {
  ...
  return Object.entries(n).forEach(([o, i]) => {
    if (D(i)) {
      const s = e ? `${e}.${o}` : o;
      Object.values(i).every((a) => te(a)) ? t[o] = s : t[o] = Vo(i, s);
      return;
    }
    t[o] = i;
  }), t;
    ...
    return e.map((t) => {
      switch (t.type) {
        case O.Separator:
          return new Qo();
        case O.Html:
          return new Se(t, this.itemsRenderParams[O.Html]);
        default:
          return new re(t, this.itemsRenderParams[O.Default]);
      }
    });
  }
  /**
...
class fs {
  ...
  constructor({ text: e, onBackButtonClick: t }) {
    ...
    }, this.nodes.backButton.innerHTML = qi, this.nodes.root.appendChild(this.nodes.backButton), this.listeners.on(this.nodes.backButton, "click", this.onBackButtonClick), this.nodes.text.innerText = this.text, this.nodes.root.appendChild(this.nodes.text);
  }
  /**
  ...
  close() {
    ...
    if (this.opened) {
      for (const [o, i] of this.tools) {
        ...
        s !== void 0 && ge.remove(this.Editor.UI.nodes.redactor, s), M(i.clear) && i.clear();
      }
    ...
    for (const [o, i] of this.tools) {
      ...
      [s].flat().forEach((c) => {
        ...
        if (u.isElement(c)) {
          ...
          e.push(g);
        } else if (c.type === O.Html)
          e.push({
            ...d,
            ...c,
            type: O.Html
          });
        else if (c.type === O.Separator)
          e.push({
            type: O.Separator
          });
        else {
...
var xn = {}, Vt = {}, Me = Ce && Ce.__spreadArray || function(n, e, t) {
  if (t || arguments.length === 2)
    for (var o = 0, i = e.length, s; o < i; o++)
      (s || !(o in e)) && (s || (s = Array.prototype.slice.call(e, 0, o)), s[o] = e[o]);
  return n.concat(s || Array.prototype.slice.call(e));
...
function Zr(n) {
  ...
  if ((0, Oo.isNativeInput)(e))
    return e.selectionEnd === e.value.length;
  var t = (0, qr.getCaretNodeAndOffset)(), o = t[0], i = t[1];
  return o === null ? !1 : (0, Vr.checkContenteditableSliceForEmptiness)(n, o, i, "right");
}
(function(n) {
...
class Ye extends E {
  ...
  setToBlock(e, t = this.positions.DEFAULT, o = 0) {
    ...
    if (!r)
      return;
    const a = u.getDeepestNode(r, t === this.positions.END), l = u.getContentLength(a);
    switch (!0) {
...
const Rn = class Dn extends E {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    if ((i.includes ? i.includes("Files") : i.contains("Files")) && !q(this.toolsFiles)) {
  ...
  async processText(e, t = !1) {
    const { Caret: o, BlockManager: i } = this.Editor, s = t ? await this.processHTML(e) : this.processPlain(e);
    if (!s.length)
      return;
    if (s.length === 1) {
    ...
    const a = i.currentBlock && i.currentBlock.tool.isDefault && i.currentBlock.isEmpty, l = 100;
    for (let c = 0; c < s.length; c += l) {
      const d = s.slice(c, c + l);
      await new Promise((h) => {
        requestAnimationFrame(() => {
          d.forEach((p, g) => {
            this.insertBlock(p, c === 0 && g === 0 && a);
          }), h();
        });
      });
    }
  ...
  getFilesConfig(e) {
    ...
    !o && !i || (o && !Array.isArray(o) && (T(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), o = []), i && !Array.isArray(i) && (T(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), i && (i = i.filter((s) => ei(s) ? !0 : (T(`MIME type value «${s}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[e.name] = {
      extensions: o || [],
      mimeTypes: i || []
    });
  }
   ...
   */
  getPatternsConfig(e) {
    e.pasteConfig === !1 || !e.pasteConfig.patterns || q(e.pasteConfig.patterns) || Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
  ...
  async processHTML(e) {
    ...
    if (e.length > t) {
      ...
      for (let s = 0; s < e.length; s += t)
        i.push(e.slice(s, s + t));
      for (const s of i)
        await this.processChunk(s, o);
    } else
      await this.processChunk(e, o);
    return o;
  }
  processChunk(e, t) {
    return new Promise((o) => {
      const i = () => {
        const s = u.make("DIV");
        s.innerHTML = e;
        const r = this.processNodes(s);
        t.push(...r), o();
      };
      typeof requestIdleCallback < "u" ? requestIdleCallback(i) : setTimeout(i, 0);
    });
  }
  processNodes(e) {
    const { Tools: t } = this.Editor, o = this.getNodes(e), i = /* @__PURE__ */ new Map();
    return o.map((s) => {
      var d;
      ...
      if (s.nodeType === Node.DOCUMENT_FRAGMENT_NODE)
        ...
        r = s, l = !0;
        const h = r.tagName;
        this.toolsTags[h] && (a = this.toolsTags[h].tool);
      } else
        return null;
      let c = i.get(a.name);
      if (!c) {
        const { tags: h = [] } = a.pasteConfig || {};
        c = this.computeToolTags(h, a.baseSanitizeConfig), i.set(a.name, c);
      }
      return ((d = r.tagName) == null ? void 0 : d.toLowerCase()) === "table" ? r = this.sanitizeTable(r, c) : r.innerHTML = Z(r.innerHTML, c), {
        content: r,
        isBlock: l,
        tool: a.name,
        event: this.composePasteEvent("tag", { data: r })
      };
    }).filter((s) => s && !u.isEmpty(s.content) && !u.isSingleTag(s.content));
  }
  computeToolTags(e, t = {}) {
    return { ...e.reduce((i, s) => (this.collectTagNames(s).forEach((a) => {
      const l = D(s) ? s[a] : null;
      i[a.toLowerCase()] = l || {};
    }), i), {}), ...t };
  }
  sanitizeTable(e, t) {
    const o = Z(e.outerHTML, t);
    return u.make("div", void 0, { innerHTML: o }).firstChild;
  }
  /**
...
class Ia extends E {
  ...
  loadStyles() {
    ...
    this.config.style && !q(this.config.style) && this.config.style.nonce && t.setAttribute("nonce", this.config.style.nonce), u.prepend(document.head, t);
  }
  /**
...
class _a {
  ...
  set configuration(e) {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (q(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && z.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
